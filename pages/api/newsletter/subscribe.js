...
// welcome mail with an unsubscribe link. It is deliberately the same shape as
  ...
  try {
    mailTransport()
      .sendMail({
        ...
        html: `
          <p>Hi,</p>
          <p>Thanks for subscribing. You'll get our latest work, marketing notes
             and offers — no noise, and never more than we'd want in our own inbox.</p>
          <p>Regards,<br/>Team Viralon</p>
          <p style="font-size:12px;color:#888">
            Didn't mean to sign up? <a href="${link}">Unsubscribe</a>.
          </p>`,
