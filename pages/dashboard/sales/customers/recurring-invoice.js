...
export default function NewInvoice() {
  ...
  //   try {
  //     if (!recurringType || !repeatEvery || !endDate) {
  //       toast.error("Please fill all recurring fields.");
  //       return;
  //     }
  ...
  //       customerEmail: selectedCustomer.email, // ✅ ADD THIS LINE
  //       invoiceNumber,
  //       referenceNumber,
  //       dueDate,
  //       subject,
  ...
  //         // 👉 ADD THIS LINE
  //        invoiceDate: new Date(Date.now() - 86400000).toISOString(), // set to yesterday
  //     };

  //     const res = await fetch("/api/sales/invoice/recurring", {
  //       method: "POST",
  ...
  //     if (result.success) {
  //       toast.success("Recurring invoice saved successfully.");
  //       // Optionally reset form or show modal
  //     } else {
  //       toast.error(result.error || "Failed to save recurring invoice.");
  //     }
  //   } catch (err) {
  ...
  // const invoiceDateObj = new Date(Date.now() - 86400000); // Yesterday
  const invoiceDateObj = new Date(); // use today

  const formattedInvoiceDate = !isNaN(invoiceDateObj)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // 🔧 FIX: Capture the preview HTML here
      ...
      // ✅ Include previewHtml in payload
      const payload = {
        customerId: selectedCustomer._id,
        ...
        repeatEvery,
        endDate,
        previewHTML: previewHtml, // <-- this is now defined
        //   invoiceDate: new Date(Date.now() - 86400000).toISOString(), // set to yesterday
            ...
            <div className="row ptb-50">
              <div className="col-lg-7 col-md-6 col-sm-12">
                <h2 className="new-invoice-heading">
                  <i className="zmdi zmdi-repeat col-blue"></i>
            ...
            <div className="admin">
              <form onSubmit={handleSubmit} className="mb-5">
                ...
                <div className="row mb-4">
                  ...
                  <div className="col-md-4">
                    <label htmlFor="repeatEvery" className="form-label">
                      Repeat Every
                    </label>
                    <input
                      type="number"
        ...
        >
          ...
          >
            <div>
              ...
              <p>
                <strong>Invoice Date:</strong> ${formattedInvoiceDate}
              </p>
