...
function MyApp({ Component, pageProps }) {
  ...
  // ✅ Check if we are on the "Your Brands BFF" page
  const isYourBrandsPage = router.pathname === "/your-brands-bff";
  ...
  return (
    <>
      <Head>
        ...
        {/* ✅ Only load global CSS if NOT on /your-brands-bff */}
        {!isYourBrandsPage && (
          <>
            <link rel="stylesheet" href="/assets/css/bootstrap.min.css" />
            <link rel="stylesheet" href="/assets/css/style.css" />
      ...
      {!isYourBrandsPage && (
        <>
          ...
          <Script src="/assets/js/magnific-popup.min.js" defer />
          <Script src="/assets/js/count-to.js" defer />
          <Script src="/assets/js/jquery.scrolla.min.js" defer />
          <Script src="/assets/js/ScrollOnReveal.js" />
          ...
          <Script src="/assets/js/horizontal-accordion-init.js" defer />
