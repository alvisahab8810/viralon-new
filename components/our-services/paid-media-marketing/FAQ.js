            ...
            <div className="accordion" id="faqAccordion">
              <div className="accordion-item">
                <h2 className="accordion-header" id="headingOne">
                  ...
                  >
                    <span className="fs-3 fw-bold me-3">01</span> What are paid
                    media ads, and how do they work?
                  </button>
                </h2>
                <div
                  id="collapseOne"
                ...
                >
                  <div className="accordion-body">
                    Paid media ads are advertisements that businesses pay for to
                    promote their products or services on various platforms,
                    such as search engines and social media. They work by
                    targeting specific audiences based on demographics,
              ...
              <div className="accordion-item">
                <h2 className="accordion-header" id="headingTwo">
                  ...
                  >
                    <span className="fs-3 fw-bold me-3">02</span> How much
                    should I budget for paid media advertising?
                  </button>
                </h2>
                <div
                  id="collapseTwo"
              ...
              <div className="accordion-item">
                <h2 className="accordion-header" id="headingThree">
                  ...
                  >
                    <span className="fs-3 fw-bold me-3">03</span> What platforms
                    do you recommend for paid media advertising?
                  </button>
                </h2>
                <div
                  id="collapseThree"
              ...
              <div className="accordion-item">
                <h2 className="accordion-header" id="headingFour">
                  ...
                  >
                    <span className="fs-3 fw-bold me-3">04</span> What is the
                    typical ROI for paid media ads?
                  </button>
                </h2>
                <div
                  id="collapseFour"
